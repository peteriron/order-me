...
export const defaultDrinks: DrinkItem[] = [
  ...
  { name: "Duvel", icon: "Beer", color: "text-amber-500" },
  { name: "Zero", icon: "Droplets", color: "text-blue-500" },
  { name: "Cola", icon: "Coffee", color: "text-orange-800" },
  { name: "Still Water", icon: "Droplets", color: "text-blue-500" },
  { name: "Sparkling W", icon: "GlassWater", color: "text-cyan-400" },
  { name: "Coffee", icon: "Coffee", color: "text-orange-800" },
  { name: "Deca", icon: "Coffee", color: "text-orange-800" },
  { name: "Thee", icon: "Coffee", color: "text-green-500" },
  { name: "Fanta", icon: "Droplets", color: "text-orange-500" },
  { name: "Ice Tea", icon: "GlassWater", color: "text-amber-500" },
  { name: "Fruit Juice", icon: "Apple", color: "text-red-500" },
  { name: "Cava", icon: "Sparkles", color: "text-yellow-400" },
  { name: "White wine", icon: "Wine", color: "text-yellow-400" },
  { name: "Rose wine", icon: "Wine", color: "text-pink-500" },
  { name: "Red wine", icon: "Wine", color: "text-red-500" },
  { name: "0.0 Beer", icon: "Beer", color: "text-blue-500" },
  { name: "Liquor", icon: "Martini", color: "text-purple-500" },
];
